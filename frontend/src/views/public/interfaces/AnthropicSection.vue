...
const anthropicMessage = computed(
  () => `curl ${anthropicBaseUrl.value}/v1/messages \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01" \\
  -H "Content-Type: application/json" \\
...
const anthropicBatch = computed(
  () => `curl ${anthropicBatchBaseUrl.value}/messages/batches \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01" \\
  -H "Content-Type: application/json" \\
  -d '{
...
const anthropicBatchList = computed(
  () => `curl "${anthropicBatchBaseUrl.value}/messages/batches?limit=20" \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01"`
)

const anthropicBatchRetrieve = computed(
  () => `curl ${anthropicBatchBaseUrl.value}/messages/batches/msgbatch_123 \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01"`
)

const anthropicBatchCancel = computed(
  () => `curl ${anthropicBatchBaseUrl.value}/messages/batches/msgbatch_123/cancel \\
  -X POST \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01"`
)

const anthropicBatchDelete = computed(
  () => `curl ${anthropicBatchBaseUrl.value}/messages/batches/msgbatch_123 \\
  -X DELETE \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01"`
...
const anthropicBatchResults = computed(
  () => `curl ${anthropicBatchBaseUrl.value}/messages/batches/msgbatch_123/results \\
  -H "x-api-key: YOUR_NEOGATE_API_KEY" \\
  -H "anthropic-version: 2023-06-01"`
)
...
const content = computed(() => {
  if (locale.value === 'zh-CN') {
    return {
      ...
      messageRequestParams: [
        ...
        ['thinking', 'object', '可选。扩展思考配置；路由到 OpenAI 兼容上游时会映射为 reasoning。'],
      ...
      batchResponseParams: [
        ...
        ['results_url', 'string | null', '上游返回的结果地址；NeoGate 通过 results 接口读取结果。']
      ],
  ...
  return {
    ...
    anthropicMessageInterfaces: [
      {
        ...
        requestParams: [
          ...
          ['tools / tool_choice', 'array | object', 'Tool definitions and tool selection strategy.']
        ],
        responseFields: [
    ...
    batchRequestParams: [
      ['requests', 'array', 'Required. Batch request entries.'],
      ['requests[].custom_id', 'string', 'Required caller-defined ID used to match result lines.'],
      [
        'requests[].params',
        'object',
  ...
  <section id="anthropic" class="docs-section">
    ...
    <div class="interface-table-wrap">
      <table class="interface-table">
        ...
        <tbody>
          <tr
            v-for="[name, method, path, , status] in content.anthropicEndpoints"
        ...
        <article class="docs-step-card">
          ...
          <div class="docs-copy-block">
            <el-button
              ...
              text
              :aria-label="t('copy')"
              @click="copyDocText(anthropicMessage)"
            />
            <pre class="docs-code-sample docs-inner-code"><code>{{ anthropicMessage }}</code></pre>
          </div>
        </article>
      </section>
      ...
      <section id="anthropic-stream" class="docs-subsection">
        ...
        <article class="docs-step-card">
          ...
          <div class="docs-copy-block">
            ...
            />
            <pre class="docs-code-sample docs-inner-code"><code>{{ anthropicStream }}</code></pre>
          </div>
        </article>
      </section>
      ...
      <section id="anthropic-batches" class="docs-subsection">
        ...
        <article class="docs-step-card">
          ...
          <div class="docs-copy-block">
            ...
            />
            <pre class="docs-code-sample docs-inner-code"><code>{{ anthropicBatch }}</code></pre>
          </div>
        </article>
        <article class="docs-step-card">
          <h3>List Batches</h3>
          <div class="docs-copy-block">
            <el-button
              ...
              text
              :aria-label="t('copy')"
              @click="copyDocText(anthropicBatchList)"
            />
            <pre
              class="docs-code-sample docs-inner-code"
            ><code>{{ anthropicBatchList }}</code></pre>
          </div>
        </article>
        <article class="docs-step-card">
        ...
        <article class="docs-step-card">
          ...
          <div class="docs-copy-block">
            <el-button
              ...
              text
              :aria-label="t('copy')"
              @click="copyDocText(anthropicBatchCancel)"
            />
            <pre
              class="docs-code-sample docs-inner-code"
            ><code>{{ anthropicBatchCancel }}</code></pre>
          </div>
        </article>
        <article class="docs-step-card">
          <h3>Delete Batch</h3>
          <div class="docs-copy-block">
            <el-button
              ...
              text
              :aria-label="t('copy')"
              @click="copyDocText(anthropicBatchDelete)"
            />
            <pre
              class="docs-code-sample docs-inner-code"
            ><code>{{ anthropicBatchDelete }}</code></pre>
          </div>
        </article>
        <article class="docs-step-card">
          <h3>Batch Results</h3>
      ...
      <section id="anthropic-models" class="docs-subsection">
        ...
        <article class="docs-step-card">
          ...
          <div class="docs-copy-block">
            ...
            />
            <pre class="docs-code-sample docs-inner-code"><code>{{ anthropicModels }}</code></pre>
          </div>
        </article>
      </section>
    </div>
